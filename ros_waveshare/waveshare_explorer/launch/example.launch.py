...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution(
                [
                    FindPackageShare("waveshare_explorer"),
                    "description", "urdf",
                    "example.urdf.xacro",
                ]
            ),
    ...
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("waveshare_explorer"), "description/rviz", "example_ws.rviz"]
    )
    ...
    gripper_controller_spawner = Node(
        package="controller_manager",
        executable="spawner",
        arguments=["gripper_position_controller"],  # Spawn the gripper controller
    )

    # NOT YET USED AS THE MAIN PURPESE IS POS
    ...
    # Delay start of joint_state_publisher_gui after `joint_state_broadcaster`
