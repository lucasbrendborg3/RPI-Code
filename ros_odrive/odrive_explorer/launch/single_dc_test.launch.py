...
def generate_launch_description():
    ...
    urdf_file = PathJoinSubstitution(
        [pkg_share, "description", "urdf", "single_dc.urdf.xacro"]
    )
    robot_controllers = PathJoinSubstitution(
        [pkg_share, "config", "single_dc_controllers.yaml"]
    )
    ...
    robot_description_content = Command([
        ...
        " ",
        PathJoinSubstitution([FindPackageShare("odrive_explorer"), "description", "urdf", "single_dc.urdf.xacro"]),
    ])
    ...
    # Delay the forward_position_controller until joint_state_broadcaster is loaded
