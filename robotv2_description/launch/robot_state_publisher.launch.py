...
# Function to process the ros2_controllers configuration
def process_ros2_controllers_config(context):
    ...
    # Define both source and install paths for the project
    src_config_path = os.path.join(home,'dev_ws/src/robotv2_ros2/robotv2_moveit_config/config',
        robot_name
    )
    install_config_path = os.path.join(home,'dev_ws/install/robotv2_moveit_config/share/robotv2_moveit_config/config',
        robot_name
    )
...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('robot_name', default_value='robotv2',
    ...
    DeclareLaunchArgument('base_type', default_value='base',
                          description='Type of the base'),
    DeclareLaunchArgument('flange_link', default_value='link6',
                          description='Name of the flange link'),
    # Gripper launch arguments
...
# Generate the launch description for the robotv2 robot visualization
#====================================================================
def generate_launch_description():
    # Define filenames for the robot description (VERY IMPORTANT)
    # ==========================================================
    urdf_package = 'robotv2_description'
    urdf_filename = 'robotv2.urdf.xacro'
    rviz_config_filename = 'robotv2_description.rviz'
    # ==========================================================
    ...
    declare_jsp_gui_cmd = DeclareLaunchArgument(
        ...
        default_value='true',
        choices=['true', 'false'],
        description='joint_state_publisher_gui on/off')
    ...
    # Create the robot description content using xacro
    ...
    # Publish the joint state values for the non-fixed joints in the URDF file (IF use_jsp is on).
    ...
    # Publish the joint state values with a GUI for controlling them
    ...
    # Declare the launch options to be used in the launch file
